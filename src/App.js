...
import trialImg from './assets/pabellon-puente.jpg'
              ...
              <Row>
                <Col md={{ span: 1, offset: 1 }}>
                  <div className='exposition-button-container'>
                    <img className='prev-img' src={trialImg} alt="imagen" />
    ...
    return (
      <div className="actual-expo">
        ...
        <div className="img-container" >
          <img src={trialImg} className='expo-title-img' alt="not working" />
        ...
        <h1 className='expo-title'>SMART MOBILITY</h1>
        ...
        <div>
          <div className='expo-content'>
            <div className='expo-subheader'>
              ...
              <p><i className
                ="material-icons reloj">schedule</i> 10-25min</p>
              <p>Exposicion temporal</p>
            </div>
  ...
  function EspacioJuegos() {
    return (
      <div className="actual-expo">
        ...
        <h1 className='expo-title'> ESPACIO JUEGOS</h1>
        <img src={logoSVG} className='expo-logo' alt="the logo" />
        <div>
          <div className='expo-content'>
            <div className='expo-subheader'>
              <p><i className
                ="material-icons reloj">schedule</i> 10 - 25 min</p>
            </div>
            <div className='expo-description'>
              <p>
                Simuladores de conducción. Videojuego de competición en circuito urbano, en el que podrás aprender aspectos claves de la movilidad sostenible al mismo tiempo que te diviertes.
              </p>
              <Link to="/plantone-b">
    ...
    return (
      <div className="actual-expo">
        ...
        <div className="img-container" >
          ...
          <div className="expo-subtitle">
            <p>PLANTA 1</p>
            <p>MOVILIDAD EN EL FUTURO</p>
          </div>
        </div>
        <h1 className='expo-title'> MOVILIDAD EN EL FUTURO</h1>
        <img src={logoSVG} className='expo-logo' alt="the logo" />
        <div>
          <div className='expo-content'>
            <div className='expo-subheader'>
              <p><i className
                ="material-icons reloj">schedule</i>5 - 10 min</p>
            </div>
            <div className='expo-description'>
              <p>
                Recorrido en realidad virtual por una ciudad del futuro. Déjate llevar en diferentes medios de transporte y experimenta como nos desplzaremos en un futuro no tan lejano.
              </p>
              <Link to="/plantone-c">
                <Button className='btn btn-primary homeButton mt-5 p-1 mx-auto'> SIGUIENTE &gt; </Button>
              </Link>
    ...
    return (
      <div className="actual-expo">
        ...
        <div className="img-container" >
          ...
          <div className="expo-subtitle">
            <p>PLANTA 1</p>
            <p>RETOS DE LA MOVILIDAD</p>
          </div>
        </div>
        <h1 className='expo-title'> LOS RETOS DE LA MOVILIDAD</h1>
        <img src={logoSVG} className='expo-logo' alt="the logo" />
        <div>
          <div className='expo-content'>
            <div className='expo-subheader'>
              <p><i className
                ="material-icons reloj">schedule</i> 5-30 min</p>
            </div>
            <div className='expo-description'>
              <p>
                Scape room de la movilidad. 10 retos en app para dispositivos móviles. Clasificaciones y competiciones. Mesas información gráfica con QR descarga. Eventos y talleres didácticos.
              </p>
              <Link to="/plant0">
                <Button className='btn btn-primary homeButton mt-5 p-1 mx-auto'> SIGUIENTE &gt; </Button>
              </Link>
  ...
  function Muevete() {
    return (
      <div className="actual-expo">
        ...
        <h1 className='expo-title'>MUÉVETE</h1>
        <img src={logoSVG} className='expo-logo' alt="the logo" />
        <div>
          <div className='expo-content'>
            <div className='expo-subheader'>
              <p><i className
                ="material-icons reloj">schedule</i> 3 min</p>
            </div>
            <div className='expo-description'>
              <p>
                Contenido generativo interactivo que reacciona al movimiento de los visitantes. Juega con la pantalla y los datos de movilidad en tiempo real.
              </p>
              <Link to="/ending">
                <Button className='btn btn-primary homeButton mt-5 p-1 mx-auto'> SIGUIENTE &gt; </Button>
              </Link>
